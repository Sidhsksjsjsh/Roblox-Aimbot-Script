if game:GetService("CoreGui"):FindFirstChild("PlayerGui") then
    game:GetService("CoreGui"):FindFirstChild("PlayerGui"):Destroy()
end
...
local Middle = "0.326547235, 0, 0.442340851, 0"
...
TextLabel.Text = "Genta X | Auto-Aim"
